	...
	config(){
		...
		return {
			...
			columns:[
				...
				{ id:"from", header:[_("From"),{content:"textFilter"}], fillspace:1, sort:"string" },
				{ id:"to", header:[_("To"),{content:"textFilter"}], fillspace:1, sort:"string" },
				{ id:"depart", header:[_("Departs"),{content:"numberFilter"}], fillspace:1, sort:"int" },
				{ id:"arrive", header:[_("Arrives"),{content:"numberFilter"}], fillspace:1, sort:"int" },
				{
					id:"status", header:[_("Status"),{content:"textFilter"}], fillspace:1, sort:"string",
					template:obj => {
